...
!(function () {
  ...
  function It() {
    ...
    ;(St = a.names), (jt = a.unicodes), (Nt = Dt(J.styleDefault, { family: J.familyDefault }))
  }
  function Lt(t, a) {
    return (Pt[t] || {})[a]
  }
  ...
  function Vt(t) {
    ...
    var a = t.iconName,
      t = t.prefix || Nt
    if (a) return (a = Yt(t, a) || a), pt(Gt.definitions, t, a) || pt(ut.styles, t, a)
  }
  var Gt = new u(),
    Kt = {
      noAuto: function () {
    ...
    return (
      ...
      s
        ? ((p = (v = t).prefix),
          ...
          (h = v.children),
          (y = v.attributes),
          (v = !0 === (v = v.symbol) ? "".concat(p, "-").concat(J.cssPrefix, "-").concat(g) : v),
          [
            {
              tag: "svg",
        ...
        (e +=
          c && w
            ? "translate("
                ...
                .concat(o.y / Z - n / 2, "em) ")
            : c
            ? "translate(calc(-50% + ".concat(o.x / Z, "em), calc(-50% + ").concat(o.y / Z, "em)) ")
    ...
    return (
      ...
      (i.iconName && i.prefix) ||
        (i.prefix &&
          0 < n.length &&
          (i.iconName =
            ((e = i.prefix), (n = t.innerText), (Ct[e] || {})[n] || Lt(i.prefix, yt(t.innerText)))),
        !i.iconName &&
          J.autoFetchSvg &&
          t.firstChild &&
