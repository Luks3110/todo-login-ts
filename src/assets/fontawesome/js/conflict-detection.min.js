...
;(t = function () {
  ...
  var s = (t.navigator || {}).userAgent,
    ...
    p = (~f.indexOf("MSIE") || f.indexOf("Trident/"), []),
    g = !1
  function h(t) {
    m && (g ? setTimeout(t, 0) : p.push(t))
  }
  m &&
    ((g = (u.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(u.readyState)) ||
  ...
  var y =
    ((function (t) {
      ...
      function a(t, e) {
        ...
        for (
          var a = 1732584193, c = -271733879, s = -1732584194, f = 271733878, l = 0;
          l < t.length;
          l += 16
        )
          (a = d((n = a), (o = c), (r = s), (i = f), t[l], 7, -680876936)),
            (f = d(f, a, c, s, t[l + 1], 12, -389564586)),
            (s = d(s, f, a, c, t[l + 2], 17, 606105819)),
            (c = d(c, s, f, a, t[l + 3], 22, -1044525330)),
            (a = d(a, c, s, f, t[l + 4], 7, -176418897)),
            (f = d(f, a, c, s, t[l + 5], 12, 1200080426)),
            (s = d(s, f, a, c, t[l + 6], 17, -1473231341)),
            (c = d(c, s, f, a, t[l + 7], 22, -45705983)),
            (a = d(a, c, s, f, t[l + 8], 7, 1770035416)),
            (f = d(f, a, c, s, t[l + 9], 12, -1958414417)),
            (s = d(s, f, a, c, t[l + 10], 17, -42063)),
            (c = d(c, s, f, a, t[l + 11], 22, -1990404162)),
            (a = d(a, c, s, f, t[l + 12], 7, 1804603682)),
            (f = d(f, a, c, s, t[l + 13], 12, -40341101)),
            (s = d(s, f, a, c, t[l + 14], 17, -1502002290)),
            (a = m(
              a,
              (c = d(c, s, f, a, t[l + 15], 22, 1236535329)),
              s,
              f,
              t[l + 1],
              5,
            ...
            (f = m(f, a, c, s, t[l + 6], 9, -1069501632)),
            (s = m(s, f, a, c, t[l + 11], 14, 643717713)),
            (c = m(c, s, f, a, t[l], 20, -373897302)),
            (a = m(a, c, s, f, t[l + 5], 5, -701558691)),
            (f = m(f, a, c, s, t[l + 10], 9, 38016083)),
            (s = m(s, f, a, c, t[l + 15], 14, -660478335)),
            (c = m(c, s, f, a, t[l + 4], 20, -405537848)),
            (a = m(a, c, s, f, t[l + 9], 5, 568446438)),
            (f = m(f, a, c, s, t[l + 14], 9, -1019803690)),
            (s = m(s, f, a, c, t[l + 3], 14, -187363961)),
            (c = m(c, s, f, a, t[l + 8], 20, 1163531501)),
            (a = m(a, c, s, f, t[l + 13], 5, -1444681467)),
            (f = m(f, a, c, s, t[l + 2], 9, -51403784)),
            (s = m(s, f, a, c, t[l + 7], 14, 1735328473)),
            (a = p(a, (c = m(c, s, f, a, t[l + 12], 20, -1926607734)), s, f, t[l + 5], 4, -378558)),
            (f = p(f, a, c, s, t[l + 8], 11, -2022574463)),
            (s = p(s, f, a, c, t[l + 11], 16, 1839030562)),
            (c = p(c, s, f, a, t[l + 14], 23, -35309556)),
            (a = p(a, c, s, f, t[l + 1], 4, -1530992060)),
            (f = p(f, a, c, s, t[l + 4], 11, 1272893353)),
            (s = p(s, f, a, c, t[l + 7], 16, -155497632)),
            (c = p(c, s, f, a, t[l + 10], 23, -1094730640)),
            (a = p(a, c, s, f, t[l + 13], 4, 681279174)),
            (f = p(f, a, c, s, t[l], 11, -358537222)),
            (s = p(s, f, a, c, t[l + 3], 16, -722521979)),
            (c = p(c, s, f, a, t[l + 6], 23, 76029189)),
            (a = p(a, c, s, f, t[l + 9], 4, -640364487)),
            (f = p(f, a, c, s, t[l + 12], 11, -421815835)),
            (s = p(s, f, a, c, t[l + 15], 16, 530742520)),
            (a = g(a, (c = p(c, s, f, a, t[l + 2], 23, -995338651)), s, f, t[l], 6, -198630844)),
            (f = g(f, a, c, s, t[l + 7], 10, 1126891415)),
            (s = g(s, f, a, c, t[l + 14], 15, -1416354905)),
            (c = g(c, s, f, a, t[l + 5], 21, -57434055)),
            (a = g(a, c, s, f, t[l + 12], 6, 1700485571)),
            (f = g(f, a, c, s, t[l + 3], 10, -1894986606)),
            (s = g(s, f, a, c, t[l + 10], 15, -1051523)),
            (c = g(c, s, f, a, t[l + 1], 21, -2054922799)),
            (a = g(a, c, s, f, t[l + 8], 6, 1873313359)),
            (f = g(f, a, c, s, t[l + 15], 10, -30611744)),
            (s = g(s, f, a, c, t[l + 6], 15, -1560198380)),
            (c = g(c, s, f, a, t[l + 13], 21, 1309151649)),
            (a = g(a, c, s, f, t[l + 4], 6, -145523070)),
            (f = g(f, a, c, s, t[l + 11], 10, -1120210379)),
            (s = g(s, f, a, c, t[l + 2], 15, 718787259)),
            (c = g(c, s, f, a, t[l + 9], 21, -343485551)),
            (a = u(a, n)),
            (c = u(c, o)),
            (s = u(s, r)),
            (f = u(f, i))
  ...
  var S = l.FontAwesomeDetection || {},
    N = a(
      ...
      {},
      { __pollUntil: C, md5ForNode: w, detectionDone: !1, nodesTested: null, nodesFound: null }
    )
  ...
  B(
    ...
    r(L, I, { fa: "solid", fass: "solid", "fa-solid": "solid" }),
    L)
  )
  var t = B(
      (r((s = {}), M, {
